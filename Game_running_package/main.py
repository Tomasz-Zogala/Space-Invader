...
from Constants_package.constants import players, enemies, guns, bonuses, enemies_laser_guns, SCREEN_WIDTH, SCREEN_HEIGHT, \
    ...
    first_stardust_wave_flag, second_stardust_wave_flag, third_stardust_wave_flag
...
# Screen
pygame.display.set_caption('Nebula Crusader')
if fullscreen_flag:
...
galactic_devourer_announcement_mR2 = galactic_devourer_announcement_m2.get_rect(
    center=(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 3 + SCREEN_HEIGHT / 8))
